...
class DataReaderRecord:
    ...
    def __init__(self, root_file_path):
        ...
        """
        post_file_path = root_file_path + "/Posts.V1.2.xml"
        badges_file_path = root_file_path + "/Badges.V1.2.xml"
        comments_file_path = root_file_path + "/Comments.V1.2.xml"
        votes_file_path = root_file_path + "/Votes.V1.2.xml"
        users_file_path = root_file_path + "/Users.V1.2.xml"
        post_links_file_path = root_file_path + "/PostLinks.V1.2.xml"
